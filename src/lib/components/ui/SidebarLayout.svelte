...
<div class="h-screen flex">
	...
	>
		<!-- Sidebar component -->
		<div
			class="flex grow flex-col gap-y-5 overflow-y-auto bg-white dark:bg-gray-900 border-r border-gray-200 dark:border-gray-700"
		>
			<div
				class="flex h-16 shrink-0 items-center px-6 border-b border-gray-200 dark:border-gray-700"
			>
					...
					<li class="mt-auto">
						<div class="border-t border-gray-200 dark:border-gray-700 pt-4">
							...
							{#if userProfile.name || userProfile.email}
								<div
									class="flex items-center gap-x-4 px-2 py-3 text-sm font-semibold leading-6 text-gray-900 dark:text-white"
								>
									<div
	...
	<div class="lg:pl-72 flex-1">
		<!-- Top bar for mobile -->
		<div
			class="sticky top-0 z-40 flex h-16 shrink-0 items-center gap-x-4 border-b border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900 px-4 shadow-xs sm:gap-x-6 sm:px-6 lg:hidden"
		>
			<button
				type="button"
