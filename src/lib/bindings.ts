 ...
 */
async submitAssessment(request: SubmitAssessmentRequest) : Promise<Result<AssessmentResponse, CommandError>> {
    try {
 ...
 */
async getAssessmentQuestions(assessmentTypeCode: string) : Promise<Result<AssessmentQuestion[], CommandError>> {
    try {
 ...
 */
async getAssessmentHistory(assessmentTypeCode: string | null, fromDate: string | null, toDate: string | null, limit: number | null) : Promise<Result<AssessmentResponse[], CommandError>> {
    try {
 ...
 */
async getLatestAssessment(assessmentTypeCode: string) : Promise<Result<AssessmentResponse | null, CommandError>> {
    try {
...
async updateActivity(id: number, request: UpdateActivityRequest) : Promise<Result<Activity, CommandError>> {
    try {
...
async getMoodHistory(fromDate: string | null, toDate: string | null, limit: number | null) : Promise<Result<MoodCheckin[], CommandError>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("get_mood_history", { fromDate, toDate, limit }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
...
async getMoodStats(fromDate: string | null, toDate: string | null) : Promise<Result<MoodStats, CommandError>> {
    try {
 ...
 */
async getAssessmentChartData(code: string, timeRange: TimeRange, fromDate: string | null, toDate: string | null) : Promise<Result<AssessmentChartData, CommandError>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("get_assessment_chart_data", { code, timeRange, fromDate, toDate }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
 ...
 */
async getMoodChartData(timeRange: TimeRange, fromDate: string | null, toDate: string | null, groupByActivity: boolean) : Promise<Result<MoodChartData, CommandError>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("get_mood_chart_data", { timeRange, fromDate, toDate, groupByActivity }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
 ...
 */
async createSchedule(request: CreateScheduleRequest) : Promise<Result<AssessmentSchedule, CommandError>> {
    try {
 ...
 */
async updateSchedule(id: number, request: UpdateScheduleRequest) : Promise<Result<AssessmentSchedule, CommandError>> {
    try {
 ...
 * Activity model
 */
export type Activity = { id: number; name: string; color: string | null; icon: string | null; created_at: string; deleted_at: string | null }
/**
 * Activity correlation with mood
 */
export type ActivityCorrelation = { activity: Activity; average_mood: number; checkin_count: number }
/**
 * Activity-specific mood data for correlation analysis
 */
export type ActivityMoodData = { activity: Activity; average_mood: number; data_points: ChartDataPoint[] }
/**
 * Assessment chart data with thresholds and statistics
 */
export type AssessmentChartData = { assessment_type: AssessmentType; data_points: ChartDataPoint[]; thresholds: ThresholdLine[]; statistics: ChartStatistics }
/**
 * Assessment question
 */
 ...
 */
export type AssessmentSchedule = { id: number; assessment_type_id: number; assessment_type_code: string; assessment_type_name: string; frequency: ScheduleFrequency; time_of_day: string; day_of_week: number | null; day_of_month: number | null; enabled: boolean; last_triggered_at: string | null; created_at: string; updated_at: string }
/**
 ...
 */
export type ChartStatistics = { min: number; max: number; average: number; trend: TrendDirection; total_assessments: number }
/**
 ...
 */
export type CreateScheduleRequest = { assessment_type_id: number; frequency: ScheduleFrequency; time_of_day: string; day_of_week: number | null; day_of_month: number | null }
/**
 ...
 */
export type MoodChartData = { data_points: ChartDataPoint[]; activity_breakdown: ActivityMoodData[]; statistics: MoodStatistics }
/**
 * Mood check-in model
 */
export type MoodCheckin = { id: number; mood_rating: number; notes: string | null; activities: Activity[]; created_at: string }
/**
 * Mood statistics (min, max, average, median, mode)
 */
export type MoodStatistics = { min: number; max: number; average: number; median: number; mode: number; total_checkins: number; checkins_per_day: number }
/**
 * Mood statistics
 */
export type MoodStats = { average_mood: number; total_checkins: number; mood_distribution: { [key in number]: number }; activity_correlations: ActivityCorrelation[] }
/**
 ...
 */
export type UpdateActivityRequest = { name: string | null; color: string | null; icon: string | null }
/**
 * Request to update an existing schedule
 */
export type UpdateScheduleRequest = { frequency: ScheduleFrequency | null; time_of_day: string | null; day_of_week: number | null; day_of_month: number | null; enabled: boolean | null }
